   ...
   async function handleSubscriber(event: FormEvent){
    ...
    return(
        <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
            <div className="w-full max-w[1100px] flex items-center justify-between p-10 mt-20 mx-auto ">
                ...
                <strong className='text-2xl mb-6 block ' >  Inscreva-se gratuitamente  </strong>
                  ...
                  <button type='submit'
                  disabled={loading}
                  className='mt-4 bg-green-500 uppercase py-4 rounded font-bold hover:bg-green-700 text-sm p-8 transition-colors disabled:opacity-50 '>
                    Garantir minha vaga
